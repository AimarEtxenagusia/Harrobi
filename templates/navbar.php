...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark px-3">
    <a class="navbar-brand animate__animated animate__slideInLeft" href="../bezeroa/bezeroa.php"><img
            src="../img/harrobi2.png" alt="Logo" class="logo" style="height:85px;"></a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
        <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item"><a class="nav-link" <?php if($user["rol"] == "admin"){ echo 'href="../langilea/langileaAdmin.php"'; } else { echo 'href="../langilea/langilea.php"'; } ?> >Langileak</a></li>
        ...
        <a href="../session/logout.php" class="btn btn-outline-light btn-sm animate__animated animate__flash">Saioa
            Itxi</a>
    </div>
</nav>